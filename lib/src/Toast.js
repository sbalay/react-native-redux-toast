Object.defineProperty(exports,"__esModule",{value:true});var _jsxFileName='src/Toast.js';var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();var _react=require('react');var _react2=_interopRequireDefault(_react);
...
{opacity:this.state.fadeAnimation,shadowOpacity:this.state.shadowOpacity}],__source:{fileName:_jsxFileName,lineNumber:70}},


_react2.default.createElement(_reactNative.View,{style:messageStyles,__source:{fileName:_jsxFileName,lineNumber:78}},
...
return(
_react2.default.createElement(_reactNative.Text,{style:this.messageStyle,__source:{fileName:_jsxFileName,lineNumber:92}},
message));
